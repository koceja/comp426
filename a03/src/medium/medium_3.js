...
export function searchName(car_data, searchTerm) {
    return car_data.filter(car => car.id.toLowerCase().includes(searchTerm.toLowerCase())).sort((a,b) => a.id.toLowerCase().indexOf(searchTerm.toLowerCase()) - b.id.indexOf(searchTerm.toLowerCase()));
}
